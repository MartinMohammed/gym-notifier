...
Studio.notify_on_people_amount_criteria(time_interested_in= TIME_INTERESTED_IN, recipient_name= MY_NAME, minimum= TARGET_MINIMUM, specific_studio_name= TARGET_STUDIO, telegram_chat_id= TELEGRAM_CHAT_ID)